...
Here are a bunch of questions to help you read the book well. The questions are simple checks, not at exam level, but lower. 
...
\begin{exercise}
Claim (that is, is the following clam correct?):  We have two continuous r.v.s. $X, Y$. Claim: even though the joint CDF factors into the product of the marginal CDFs of $X$ and $Y$, it  is still possible in general that the joint PDF does not factors into a product of marginals PDFs of $X$ and $Y$.
\end{exercise}
...
\begin{exercise}
`The man on the street' says that two throws of a die are independent, but does not mention the joint CDF. What do you think of this claim of independence.  From this exercise you should memorize this: \textbf{independence is a property of the joint CDF, not of the rvs}.
\end{exercise}
...
Most of the exercises of the book are at about (or just a bit above)  exam level. 
...
\begin{exercise}
Take $X\sim\Unif{\{-2, -1, 1, 2\}}$ and $\eta = X^2$. What is the correlation coefficient of $X$ and $\eta$? Comment on your answer. 
...
These coding exercises address this skill.
...
The idea is that you copy the code, you are to run it, and you can explain how it works.
...
You should know, however, that many of you  will need both languages later in life.
