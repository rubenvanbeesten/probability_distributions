...
The document =memoryless excursions.pdf= (henceforth referred to as ME) discusses the core concepts of BH.7.1 (BH = Blitzstein and Hwang), and contain worked solutions to show you the type of computations you are supposed to master. 
...
* Assignments
There are 6 assignments, one for each lecture week, except for the first week. The guidelines are in =assignments.pdf=.
